                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                        <button 
                            ...
                            className={`border hover:bg-slate-50 px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-semibold transition-colors ${
                                filterActive !== "ALL" ? "bg-blue-50 text-blue-700 border-blue-300" : "bg-white text-slate-700 border-slate-300"
                            }`}
                        >
                            <Filter className="w-4 h-4" />
                            {filterActive === "ALL" ? "All" : "Active Only"}
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                ...
                                const filtered = employees.filter(emp => {
                                    ...
                                    const matchesFilter = filterActive === "ALL" || emp.isActive
